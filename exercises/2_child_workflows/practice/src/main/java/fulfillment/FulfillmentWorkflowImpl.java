...
public class FulfillmentWorkflowImpl implements FulfillmentWorkflow {
    ...
    public OrderResult processOrder(Order order) {
        ...
        //   Use Workflow.newChildWorkflowStub(InventoryReservationWorkflow.class, ...)
        //   with ChildWorkflowOptions that set workflowId = "inventory-" + order.getOrderId().
        //   Call inventoryWorkflow.reserve(order.getItemSku(), order.getQuantity()) to get reservationId.
        String reservationId = null; // replace this
